            ...
            <BrowserRouter basename={'/'}>
                <PageScrollTop>
                    <Switch>
                        ...
                        <Route exact path={`${process.env.PUBLIC_URL}/product-details`} component={ProductDetails}/>
                        <Route exact path={`${process.env.PUBLIC_URL}/contact`} component={Contact}/>
                        <Route exact path={`${process.env.PUBLIC_URL}/calculators`} component={Calculators}/>
